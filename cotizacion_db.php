...
if($tipo == 'catalogo') {
	...
	$sql = "Select catalogo.id,catalogo.nombre,catalogo.descripcion,catalogo.precio,catalogo.imagen,tipos.id categoria_id,catalogo.imagen,tipos.nombre nombre_cat 
